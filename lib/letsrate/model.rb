...
module Letsrate
  ...
  module ClassMethods
    ...
    def letsrate_rateable(*dimensions)
      has_many :rates_without_dimension, lambda { where(:dimension => nil) }, :as => :rateable, :class_name => "Rate", :dependent => :destroy
      has_many :raters_without_dimension, :through => :rates_without_dimension, :source => :rater

      has_one :rate_average_without_dimension, lambda { where(:dimension => nil) }, :as => :cacheable, :class_name => "RatingCache", :dependent => :destroy
